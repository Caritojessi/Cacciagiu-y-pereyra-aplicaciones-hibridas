...
router.get('/api/actividades', verificarToken, (req, res) => {
...
router.post("/api/actividades/ciudad/", verificarToken, (req, res) => {
...
router.post('/api/actividades/id/', verificarToken, (req, res) => {
    let body = req.body
    let id = body._id;
...
router.get('/api/actividades/orden/ascendente', verificarToken, (req, res) => {
...
router.get('/api/actividades/orden/descendente', verificarToken, (req, res) => {
...
router.post('/api/actividades/filtrado/', verificarToken, (req, res) => {
    try {
        let body = req.body
...
router.put('/api/actividades/', verificarToken, async (req, res) => {
    let body = req.body
...
router.delete('/api/actividades/', verificarToken, async (req, res) => {
    let id = req.body._id
    try {
...
router.get('/api/actividades/paginas/:page/:pageSize', verificarToken, (req, res) => {
...
router.post('/api/actividades/nombre/', async (req, res) => {
    try {
        let body = req.body
