...
router.get('/api/localidades', verificarToken, (req, res) => {
...
router.post('/api/localidades/nombre/', verificarToken, async (req, res) => {
...
router.post('/api/localidades/id/', verificarToken, (req, res) => {
...
router.put('/api/localidades/', verificarToken, async (req, res) => {
    let body = req.body;
    let id = body._id
    try {
...
router.delete('/api/localidades/', verificarToken, async (req, res) => {
    let id = req.body._id
    try {
...
router.get('/api/localidades/orden/ascendente', verificarToken, (req, res) => {
...
router.get('/api/localidades/orden/descendente', verificarToken, (req, res) => {
