...
const Contacto = () => {
    ...
    return (
        <div className="w-full h-full text-purple-800 text-start">
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between max-w-4xl mx-auto">
                <form 
                    action="https://formsubmit.co/carolina.cacciagiu@davinci.edu.ar" 
                    method="POST" 
                    className="mb-4 space-y-4 flex-1 w-full lg:w-auto lg:flex-none lg:max-w-sm mx-auto lg:mx-0" 
                    style={{ width: '90%' }}
                >
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="w-full bg-violet-300 px-3 py-2 border border-purple-200 rounded-md text-violet-950 font-semibold shadow-inner focus:ring-2 focus:ring-purple-500 transition-colors duration-300" 
                ...
                <div className="flex-1 mt-8 lg:mt-0 lg:ml-8">
                    <img src={Planificacion} alt="Planificación" className="w-full h-auto lg:max-w-md rounded-md mt-20 mx-auto lg:mx-0" />
                </div>
            </div>
        </div>
    );
