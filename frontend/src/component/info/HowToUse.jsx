            ...
            <div className="bg-gradient-to-r via-purple-100 to-pink-100 min-h-screen p-4 bg-white">
                <Section>
                    ...
                    <div className="md:w-1/3 flex flex-col justify-center px-4 text-left">
                        ...
                        <p className="text-lg md:text-xl mb-4 text-gray-700">
                            Mira lo rápido que <strong className='text-purple-900'>Agenda VIAJERA</strong> puede dar sentido a tus planes y crear sencillamente un único itinerario para cada <em>viaje</em>.
                        </p>
                    </div>
                </Section>
                ...
                <Section delay={0.1}>
                    <div className="md:w-1/2 flex flex-col justify-center px-4 text-left">
                        ...
                        <p className="text-lg md:text-xl mb-4 text-gray-700">Para acceder a todas las funcionalidades de <strong className='text-purple-900'>Agenda VIAJERA</strong>, primero debes iniciar sesión en la aplicación. Una vez que hayas ingresado tus credenciales, podes:</p>
                        <ul className="list-none text-slate-800">
                            ...
                            <li className="flex items-center mb-2">
                                <FaHome className="text-purple-800 mr-2" />
                                Planificar y agregar actividades a tu itinerario de viaje.
                            </li>
                        </ul>
                    </div>
                    <div className="md:w-1/2 flex justify-center mb-8 md:mb-0">
                        <img src={Pasaporte} alt="Imagen de pasaporte" className="max-w-full h-auto md:w-3/4 lg:w-1/2 rounded-lg" />
                    </div>
                </Section>
                ...
                <Section delay={0.1}>
                    ...
                    <div className="md:w-1/2 flex flex-col justify-center px-4 text-left">
                        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-purple-800">Paso 2: Obtenne un itinerario completo</h2>
                        <p className="text-lg md:text-xl mb-4 text-gray-700">Accede a la información de tu viaje sobre la marcha, cuando más la necesite. Podes cargar fácilmente planes a tu calendario.</p>
                    </div>
                </Section>
                ...
                <Section delay={0.1}>
                    ...
                    <div className="md:w-1/2 flex flex-col justify-center md:order-1 px-4 text-left">
                        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-purple-800">Paso 3: Descarga la aplicación</h2>
                        <p className="text-lg md:text-xl mb-4 text-gray-700"> 
                            Si quieres tener todos tus planes del viaje en tu mano, en tu muñeca o en tu escritorio, <strong className='text-purple-900'>Agenda VIAJERA</strong> está disponible en todo momento.
                        </p>
                    </div>
                </Section>
