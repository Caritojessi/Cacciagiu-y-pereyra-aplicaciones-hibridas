        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r">
            ...
            <div className="relative z-10 max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-500 hover:scale-105 flex flex-col md:flex-row">
                <div className="p-6 md:p-8 order-1 md:order-2 flex-1">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mt-4 mb-4">Descarga la Aplicación</h1>
                  
                    <p className="text-lg text-left text-gray-700 mb-6">Organiza tus viajes de manera fácil y sencillo. <strong>Agenda VIAJERA</strong> ofrece la ayuda para mantener tus planes organizados y poder disfrutar cada momento del viaje.</p>
                    <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 justify-center">
                        <a href="#" className="inline-block bg-purple-600 hover:bg-purple-600 text-white px-6 py-3 rounded-md font-semibold shadow-md transition duration-300">Descargar para iOS</a>
                        <a href="#" className="inline-block bg-purple-600 hover:bg-purple-600 text-white px-6 py-3 rounded-md font-semibold shadow-md transition duration-300">Descargar para android</a>
                    </div>
                </div>
