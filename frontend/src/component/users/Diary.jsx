...
import backgroundImageRight from '../../assets/parte.png'; 
import backgroundImageLeft from '../../assets/parte-copia.png'; 
        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600">Descubrí todo lo que puedes hacer con nuestra herramienta</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-gray-600 text-left">Accede a tu panel de control viajero y visualiza toda tu información de viajes.</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-gray-600 text-left">Registra y controla siempre todos tus gastos de viaje fácilmente.</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-gray-600 text-left">Encuentra actividades recomendadas y lugares para visitar.</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-gray-600 text-left">Planifica tus próximos viajes teniendo nuestras recomendaciones con facilidad.</p>
                    </div>
                </div>
            </div>
        </div>
